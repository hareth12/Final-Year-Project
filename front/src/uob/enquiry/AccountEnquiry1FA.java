...
public class AccountEnquiry1FA extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		System.out.println("accountEnquiry1FA -get");
		...
		if(validCookieBool){
			...
			RequestDispatcher dispatcher = request.getRequestDispatcher("/jsp/accountSummary/accountSummary1FA.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		System.out.println("accountEnquiry1FA -post");
