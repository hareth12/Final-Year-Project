...
public class AccountEnquiry2FA extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AccountEnquiry2FA() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(validCookieBool){
			...
			RequestDispatcher dispatcher = request.getRequestDispatcher("/jsp/accountSummary/accountSummary2FA.jsp");
