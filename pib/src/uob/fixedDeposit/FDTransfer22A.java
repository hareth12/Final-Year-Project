...
public class FDTransfer22A extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FDTransfer22A() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(validCookieBool){
			...
			String amountString = request.getParameter("amount2");
			
			System.out.println("fromAccountFDString ="+fromAccountFDString);
			System.out.println("toAccountFDString ="+toAccountRBKString);
					...
					if(toAccountRBKString!=null){
						...
						if(amountString!=null){
							...
							if(a){
								...
								+toAccountRBKString+" is successful. ";
								
								b=true;
							}else
								displayString="Fund Transfer from Fixed Deposit Account "+fromAccountFDString+" to Retail Account "
								+toAccountRBKString+" is not successful. ";
						}
					}
				}
