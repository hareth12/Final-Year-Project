...
public class ChangePassword2FA extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ChangePassword2FA() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(userHash!=null){
			...
			System.out.println("<pib><ChangePassword2FA>userHash from Client is null!");
		}
		
		
		if(validCookieBool){
			String userName=ssocs.getLoginName(userHash);
			System.out.println("<fyp2><ChangePassword2FA>userName= "+userName);
			
			RequestDispatcher dispatcher = request.getRequestDispatcher("/Password/changePassword2FA.jsp");
