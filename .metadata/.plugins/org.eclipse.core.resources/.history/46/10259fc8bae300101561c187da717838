 ...
 */
public class AddPayee2FA1Action extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AddPayee2FA1Action() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		System.out.println("Addpayee2fa1action-get");
		...
		if(userHash!=null){
			...
			System.out.println("<fyp2><AddPayee2FA1Action>userHash from Client is null!");
		}
		...
		if(validCookieBool){
			...
			System.out.println("fromAccountString = "+fromAccountString);
			...
			System.out.println("<fypWebService><AddPayee2FA1Action> userName    = "+userName);
			System.out.println("<fypWebService><AddPayee2FA1Action> fromAccount = "+fromAccountString);
			
			
			RequestDispatcher dispatcher = request.getRequestDispatcher("/jsp/fundTransfer/addPayee2.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		System.out.println("Addpayee2fa1action-post");
