...
<ul id="nav" class="dropdown dropdown-vertical">
	...
	<div id="main">
		...
		<jsp:scriptlet>	String from  = (String) request.getAttribute("fromAccount");</jsp:scriptlet>
		<form id="form1" name="form1" method="post" action="/pibChinese/AddPayee2FA1Action2">
		<p>
				<label>&#24080;&#25143;&#36873;&#25321;</label>
				<%int i =0;
		...
		<br></br>
		      ...
		      <br></br>
				<label>
		        <input type="submit" name="select" id="select" value="&#32943;&#23450;" />
		      </label>
			</p>	
				</form>
