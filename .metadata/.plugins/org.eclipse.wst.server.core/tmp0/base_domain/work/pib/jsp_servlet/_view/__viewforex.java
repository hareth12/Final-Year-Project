...
public final class __viewforex extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/View/viewForex.jsp", 1319442984429L ,"10.3.5.0","Asia/Singapore")) return true;
        return false;
    }
