...
public final class __fundtransfer2fa1 extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/fundTransfer/fundTransfer2FA1.jsp", 1318763575556L ,"10.3.5.0","Asia/Singapore")) return true;
        return false;
    }
    ...
    private final static java.lang.String  _wl_block1 =" String[][] y = (String[][])request.getAttribute(\"accounts\");  ";
    private final static byte[]  _wl_block1Bytes = _getBytes( _wl_block1 );

    private final static java.lang.String  _wl_block2 ="\r\n\t\t<form id=\"form1\" name=\"form1\" method=\"post\" action=\"/pib/FundTransfer2FA1Action\">\r\n\t\t<p>\r\n\t\t\t\t<label>From</label>\r\n\t\t\t\t";
 ...
 String[][] y = (String[][])request.getAttribute("accounts");  
