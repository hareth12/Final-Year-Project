...
public final class __enquiry2fa extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/enquiry/enquiry2FA.jsp", 1319442806021L ,"10.3.5.0","Asia/Singapore")) return true;
        return false;
    }
