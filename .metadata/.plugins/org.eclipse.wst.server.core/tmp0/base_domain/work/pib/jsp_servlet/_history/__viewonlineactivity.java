...
public final class __viewonlineactivity extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/History/ViewOnlineActivity.jsp", 1318763611872L ,"10.3.5.0","Asia/Singapore")) return true;
        return false;
    }
    ...
    private final static java.lang.String  _wl_block1 ="\r\n\t\t<tr>\r\n\t\t  <td>Time</td><td>Txn Name</td> <td>Amount</td><td>Status</td><td>Txn Number</td> \r\n\t\t</tr>\r\n\t\t\r\n\t\t\t";
 ...
 int i = 0;
		while(x[i][0]!=null){
			out.println("<tr>"+
						"<td>"+x[i][0]+"</td><td>"+x[i][1]+"</td><td>"+x[i][2]+"</td><td>"+x[i][3]+"</td><td>"+x[i][4]+
						"</td></tr>");
			i++;			
			}
