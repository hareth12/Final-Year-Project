...
public final class __viewunittrust extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/View/viewUnitTrust.jsp", 1319443004449L ,"10.3.5.0","Asia/Singapore")) return true;
        return false;
    }
