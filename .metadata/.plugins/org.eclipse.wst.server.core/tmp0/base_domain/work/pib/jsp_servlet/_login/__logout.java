...
public final class __logout extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/Login/logout.jsp", 1317406937973L ,"10.3.5.0","Asia/Singapore")) return true;
        return false;
    }
