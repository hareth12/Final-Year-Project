...
public final class __login2fa extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/Login/login2FA.jsp", 1317406948097L ,"10.3.5.0","Asia/Singapore")) return true;
        return false;
    }
