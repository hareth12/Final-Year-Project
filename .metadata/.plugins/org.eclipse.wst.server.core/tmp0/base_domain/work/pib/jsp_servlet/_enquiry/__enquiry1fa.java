...
public final class __enquiry1fa extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/enquiry/enquiry1FA.jsp", 1319450346616L ,"10.3.5.0","Asia/Singapore")) return true;
        return false;
    }
