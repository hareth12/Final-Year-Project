...
public final class __placement2 extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/FixedDeposit/Placement2.jsp", 1318782419511L ,"10.3.5.0","Asia/Singapore")) return true;
        return false;
    }
 ...
 i = 0;
		while(y[i][0]!=null){
            ...
            out.print( request.getAttribute("displayString"));
