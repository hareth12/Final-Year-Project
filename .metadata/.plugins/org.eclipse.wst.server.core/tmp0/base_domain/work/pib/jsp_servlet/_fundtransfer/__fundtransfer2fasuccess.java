...
public final class __fundtransfer2fasuccess extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/fundTransfer/fundTransfer2FASuccess.jsp", 1318763603651L ,"10.3.5.0","Asia/Singapore")) return true;
        return false;
    }
