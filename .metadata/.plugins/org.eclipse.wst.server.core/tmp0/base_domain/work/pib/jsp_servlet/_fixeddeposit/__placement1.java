...
public final class __placement1 extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/FixedDeposit/Placement1.jsp", 1318781845987L ,"10.3.5.0","Asia/Singapore")) return true;
        return false;
    }
 ...
 i = 0;
		while(y[i][0]!=null){
			out.println("<tr>"+
						"<td>"+y[i][0]+"</td><td>"+y[i][1]+"</td><td>"+y[i][2]+"</td><td>"+y[i][3]+"</td><td>"+y[i][4]+"</td><td>"+y[i][5]+
						"</td></tr>");
			i++;			
			}
