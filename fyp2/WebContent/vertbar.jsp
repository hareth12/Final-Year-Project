...
<body>
	<div id="wrapper">
		<div id="mainContent">
            <img src="_assets/_images/vanGogh.jpg" class="imgOverlayWidth" alt="Van Gogh"/>
            <div id="logo">
                <img src="_assets/_images/logo.gif" alt="United Overseas Bank"/>
            </div>
            <div id="horNavBar">
                <ul>
                    <li><a href="vertBar.html" class="current">AAAA</a></li>
                    <li><a href="vertBar.html" class="holder">BBBB</a></li>
                    <li><a href="vertBar.html" class="holder">CCCC</a></li>
                </ul>	
            </div>
            <div id="vertNavBar">
                <ul>
                    <li><a href="#" class="current">AAAA</a></li>
                    <li><a href="#" class="holder">BBBB</a></li>
                    <li><a href="#" class="holder">CCCC</a></li>
                </ul>	
            </div>
  		</div>     
     	<div id="footer">
