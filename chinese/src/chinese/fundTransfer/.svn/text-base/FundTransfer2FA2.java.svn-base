 ...
 */
public class FundTransfer2FA2 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FundTransfer2FA2() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(userHash!=null){
			...
			System.out.println("<fyp2><FundTransfer2FA2>userHash from Client is null!");
		}
		...
		if(validCookieBool){
			...
			System.out.println("<fyp2><FundTransfer2FA2> indexHash = "+indexHash);
			System.out.println("<fyp2><FundTransfer2FA2> hash2FA   = "+hash2FA);
			...
			if(x.getPayPayee2FA2Success()){
				...
				RequestDispatcher dispatcher = request.getRequestDispatcher("/fundTransfer/fundTransfer2FASuccess.jsp");
