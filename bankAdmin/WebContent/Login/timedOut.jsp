...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Pseudo Bank PIB Bank Admin Login</title>
         
<link rel="stylesheet" type="text/css" href="/bankAdmin/asset/login/home.css"/>
</head>
    <body class="small login">
        <div id="wrapper">
    <div id="header"><h1><a href="/">Pseudo Bank PIB Bank Admin</a></h1></div>
    <div class="container">
        ...
        <div id="content">
                ...
                <form name="f_0_11_1_3_1" method="post" action="/bankAdmin/LoginAction">
                    <table class="login" style="margin-left: auto; margin-right: auto;">
                        <tr>
                            <td><p class="mtop0 mbottom025"><strong>
                            You have been logged out of your Pseudo Bank PIB Bank Admin session due to one of the following reasons: 
						<br></br>			
